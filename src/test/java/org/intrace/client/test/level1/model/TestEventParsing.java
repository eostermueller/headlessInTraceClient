...
public class TestEventParsing {
	...
	@Test
	public void canParseTraceEvent_ENTRY() {
	...
	@Test 
	public void canParseTraceEvent_ARG() {
	...
	@Test 
	public void canParseTraceEvent_ENTRY2() {
	...
	@Test 
	public void canParseTraceEvent_EXIT() {
		String rawEventText = "[18:07:53.681]:[67]:org.hsqldb.jdbc.jdbcConnection:checkClosed: }";
		ITraceEvent expectedEvent = new DefaultTraceEvent(
				rawEventText,						//raw event text
				"org.hsqldb.jdbc",	//package
	...
	@Test 
	public void canParseTraceEvent_CONSTRUCTOR_ENTRY() {
	...
	@Test 
	public void canParseTraceEvent_CONSTRUCTOR_ARG() {
...
//[18:07:53.681]:[67]:org.hsqldb.jdbc.jdbcStatement:<init>: Arg: 1003
	@Test 
	public void canParseTraceEvent_CONSTRUCTOR_ARG2() {
 ...
 */
	@Test 
	public void canParseTraceEvent_CONSTRUCTOR_EXIT() {
		String rawEventText = "[18:07:53.681]:[67]:org.hsqldb.jdbc.jdbcStatement:<init>: }";
		ITraceEvent expectedEvent = new DefaultTraceEvent(
				rawEventText,						//raw event text
				"org.hsqldb.jdbc",	//package
	 ...
	 */
	@Test 
	public void canParseTraceEvent_RETURN() {
		String rawEventText = "[18:07:53.682]:[67]:org.hsqldb.jdbc.jdbcConnection:nativeSQL: Return: INSERT INTO Event (name, description, date, location) VALUES(?, ?, ?, ?)";
		ITraceEvent expectedEvent = new DefaultTraceEvent(
				rawEventText,						//raw event text
				"org.hsqldb.jdbc",	//package
				"jdbcConnection",					//class
	 ...
	 */
	@Test
	public void canParseTraceEvent_RETURN_WithExtraSquareBrackets() {
	 ...
	 */
	public void canParseEventWith_array_return() {
	...
	@Test
	public void canParseEventWithNamedArg() {
