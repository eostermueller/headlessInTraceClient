...
public class ConnectionTestUtils {
	...
	/**
	 * org.headlessintrace.test.webapp.servlet.HelloWorld.doGet
	 */
	public static final String TEST_WEB_REQUEST_COMPLETION_CLASS = "org.headlessintrace.test.webapp.servlet.HelloWorld";
